...
$auth_users = array(
    'admin' => '$2y$10$V/0b7DyeXnRRFH3j6vC59OnOj3gwlHdSDNCO4tvNFm7eO/vP3N.su', //thecodingtime
    'user' => '$2y$10$PJPPDO20T9evs.PefZh25eucJhEEH3T1LEIhT9iH54T7XYb9cpTvW' //thecodingtimeofficial
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://github.com/thecoding-time/filemanagertiny" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Shaan Jain</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/thecoding-time/filemanagertiny" target="_blank" class="app-v-title"> Tiny File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Shaan Jain</p>
                        <p>Mail Us: <a href="mailto:thecodingtime@gmail.com">thecodingtime</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://github.com/thecoding-time/filemanagertiny/issues" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://github.com/thecoding-time/filemanagertiny" target="_blank" class="float-right text-muted">Tiny File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://github.com/thecoding-time/filemanagertiny" target="_blank" class="float-right text-muted">Tiny File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
...
<head>
    ...
    <meta name="author" content="Shaan Jain">
